...
module.exports.languages = {
    "vi": {
        ...
        "mention": "con vợ %1 đứng hạng %2 với %3 tin nhắn",
        "myself": "con vợ đã nhắn được %2 tin nhắn và được xếp hạng %1 !\nChơi đẹp đi nhá , đừng có mà chơi spam nha con vợ 😾"
    },
    "en": {
...
module.exports.run = async function ({ args, api, event, Currencies, getText }) {
    ...
    try {
        ...
        if (args[0] == "all") {
            ...
            msg += `               ❧ Trang ${page}/${numPage} ☙\n☞ Dùng "${global.config.PREFIX}checktt all + [số trang]" để xem các trang sau nha các con vợ!`

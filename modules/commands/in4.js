...
module.exports.run = async({api,event,args}) => {
  ...
  {body:`梁Admin Bot梁\n
👀 Tên: Lương Minh Khánh
❎ Tuổi: 17 🐒
👤 Giới tính: Nam
💫 Chiều cao cân nặng: 1m72 x 55kg
...
💻Contact💻
☎ SĐT&Zalo:096.264.2005
🌐 Facebook: https://www.facebook.com/User.minhkhanhDVFB
✉️ Email: tretrauspfb2k4@gmail.com`,
    attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => 
    fs.unlinkSync(__dirname + "/cache/1.png"));  
      return request(
        encodeURI(`https://graph.facebook.com/${100064210099616}/picture?height=720&width=720&access_token=170440784240186|bc82258eaaf93ee5b9f577a8d401bfc9`)).pipe(

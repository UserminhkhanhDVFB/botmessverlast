    ...
    case "-t":
      {
        ...
        return api.sendMessage(listBanned.length != 0 ? api.sendMessage(`?Hi?n t?i dang có ${listBanned.length} nhóm b? ban\n\n${listBanned.join("\n")}` +
          "\n\nReply tin nh?n này + s? th? t? d? unban thread tuong ?ng",
          threadID, (error, info) => {
          ...
          messageID
        ) : "Hi?n t?i không có nhóm nào b? ban!", threadID, messageID);
      }
    case "user":
    case "u":
    case "-u":
      {
        ...
        return api.sendMessage(listBanned.length != 0 ? api.sendMessage(`?Hi?n t?i dang có ${listBanned.length} ngu?i dùng b? ban\n\n${listBanned.join("\n")}` +
          "\n\nReply tin nh?n này + s? th? t? d? unban user tuong ?ng",
          threadID, (error, info) => {
          ...
          messageID
        ) : "Hi?n t?i không có ngu?i dùng b? ban", threadID, messageID);
      }
